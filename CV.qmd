...
### Senior Lecturer / Research Fellow - Level C, Research only function

***University of New South Wales***, Sydney [Mar 2025 -- Present]{.cvdate}

- Foundations for leading the nature positive ecosystem conservation agenda in Australia
- Ecosystem Indicators Workflows

### Senior Research Fellow / Senior Lecturer

***University of New South Wales***, Sydney [Oct 2022 -- Feb 2025]{.cvdate}
...
- Co-lead of the **Red List of Ecosystem (RLE) Thematic group**
...
Member of the **Society for Conservation Biology** (Washington D.C., USA):
- Handling editor for **Conservation Biology** journal
- Member of the Oceania section

Member of the **Ecological Society of Australia** and **Sociedad Venezolana de Ecología**.
...
- $>40$ peer reviewed publications in scientific journals, two books, one book chapter and one article in conference proceedings,
  - [Google Scholar](https://scholar.google.es/citations?user=A2Thq5UAAAAJ&hl=en) (since 2021): H-index = 21 (14), i10-index = 28 (20); citations = 1842 (1470)
  - [Scopus](https://www.scopus.com/authid/detail.uri?authorId=6507728759): H-index = 16, 41 documents, 1,070 citations by 950 documents, 
  - [Web of Science](https://www.webofscience.com/wos/author/record/M-3785-2015): H-index = 14, 39 publications, 820 citations by 704 documents (excluding self-citations),  42 verified peer reviews
...
- Contributions to open and reproducible science including pre-prints, reports, datasets, code and software in open access research repositories,
  - [DataCite Commons](https://commons.datacite.org/orcid.org/0000-0002-9554-3395): 432 works with 55 citations, 91% with open access licenses
  - [Figshare](https://figshare.com/authors/Jos_R_Ferrer_Paris/592994): 63 contributions, 70,561 item views, 26,859 item downloads, 6 citations
  - [Zenodo](https://zenodo.org/search?q=metadata.creators.person_or_org.name%3A%22Ferrer-Paris%2C%20Jose%20R.%22&l=list&p=1&s=10&sort=bestmatch): 122 contributions, [OSF](https://osf.io/7q5ny/): 9 public projects, [GitHub](https://github.com/jrfep): 106 repositories

## RESEARCH GRANTS

ARDC, Australian Research Data Commons

- Project lead, 1,000,000 AUD ARDC Co-investment (2026-2028)
- Member of Project lead team, 1,000,000 AUD ARDC Co-investment (2025-2027)
...
**Red List training workshop**, Lima, Perú [2025]{.cvdate}

- Contribution to cross-referencing national ecosystem map to Global Ecosystem Typology
- Red List of Ecosystem training workshop
- Equal contribution to convening and delivering of workshop

**Red List training workshop**, Abu Dhabi, United Arab Emirates [2025]{.cvdate}

- Global Ecosystem Typology, Green Status of Ecosystems and Red List of Ecosystem training workshops
- Supporting roles in convening and delivery

**Skills seminar for HDR students** [2023-2024]{.cvdate}
...
- Invited presentation: [Estado actual del conocimiento en la evaluación de riesgo al colapso de ecosistemas](https://jrfep.quarto.pub/uicn-lre-estado-actual/) Virtual seminar of the IUCN Commission for Ecosystem Management (Latin America and Caribbean section) (August 2025)
